...
Please cite the underlying Bioconductor packages:

-   DEXSeq — Differential exon usage
-   ASpli — Alternative splicing analysis
-   edgeR — Differential analysis of count data
...
If adding a new method or outputs, include: - Example dataset or
synthetic generator - Clear parameter docs in script header - Basic
...
Add a license file (e.g., MIT or GPL-3.0). See choosealicense.com.

------------------------------------------------------------------------

Maintainer: @vipulkonda
